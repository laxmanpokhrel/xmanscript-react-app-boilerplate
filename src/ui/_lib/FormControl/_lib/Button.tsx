  ...
  'naxatw-inline-flex naxatw-items-center naxatw-justify-center naxatw-rounded-md naxatw-text-sm naxatw-font-medium naxatw-transition-all focus-visible:naxatw-outline-none focus-visible:naxatw-ring-2 focus-visible:ring-ring focus-visible:naxatw-ring-offset-2 disabled:naxatw-opacity-50 disabled:naxatw-pointer-events-none ring-offset-background',
  {
    variants: {
      variant: {
        ...
        'secondary-disabled':
          'naxatw-cursor-default naxatw-border naxatw-border-gray-400 naxatw-text-gray-400 naxatw-font-[700] naxatw-text-[14px] naxatw-pointer-events-none',
        'link-disabled':
          'naxatw-cursor-default naxatw-text-gray-400 naxatw-font-[700] naxatw-text-[14px] naxatw-pointer-events-none',
        ...
        'icon-primary': 'naxatw-border-none hover:naxatw-bg-teal-green-50',
      ...
      size: {
        ...
        'drop-md': 'naxatw-h-9 naxatw-px-[0.75rem] naxatw-rounded-md',
        'drop-sm': 'naxatw-h-8 naxatw-px-[0.75rem] naxatw-rounded-md',
      },
    },
    defaultVariants: {
      variant: 'primary',
