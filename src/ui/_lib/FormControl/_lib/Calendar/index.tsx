 ...
 */
function Calendar({ selected, onSelect, ...props }: any) {
  return (
    <DayPicker
      mode="single"
      selected={selected}
      ...
      fromYear={2000}
      toYear={2025}
      className="naxatw-p-[2px] naxatw-m-0 naxatw-rounded-lg !naxatw-w-full"
      classNames={{
        months:
        ...
        cell: 'hover:naxatw-bg-gray-200 naxatw-overflow-hidden naxatw-m-1',
        day: 'naxatw-w-full naxatw-px-[4px] naxatw-py-[2px]',
        selected: '!naxatw-bg-blue-500',
        day_selected: 'hover:naxatw-blue-400 !naxatw-bg-blue-500 naxatw-b-2 !naxatw-text-white',
        day_today: 'naxatw-bg-teal-green-500 naxatw-text-white naxatw-font-bold',
